...
protected:
  ...
  void verifyCameras(const RECONSTRUCTION& reconstruction) {
    ...
    for (const auto& [cam_id, reconstructed_calib] : reconstructed_cameras) {
      ...
      EXPECT_NEAR(recon_cam_in_world[0], true_cam_in_world[0], cam_t_abs_tolerance_);
      EXPECT_NEAR(recon_cam_in_world[1], true_cam_in_world[1], cam_t_abs_tolerance_);
      EXPECT_NEAR(recon_cam_in_world[2], true_cam_in_world[2], cam_t_abs_tolerance_);
  ...
  void verifyWorldPoints(const RECONSTRUCTION& reconstruction) {
    ...
    for (const auto& [pt_id, reconstructed_pt_data] : reconstructed_points) {
      ...
      EXPECT_NEAR(recon_world_pt[0], true_world_pt[0], world_pt_abs_tolerance_);
      EXPECT_NEAR(recon_world_pt[1], true_world_pt[1], world_pt_abs_tolerance_);
      EXPECT_NEAR(recon_world_pt[2], true_world_pt[2], world_pt_abs_tolerance_);
